        ...
        <?php if ($mahasiswa): ?>
            <div class="card">
                <div class="card-header">
                    <img src="<?php echo !empty($mahasiswa['foto_profile'])
                                    ? 'assets/images/' . $mahasiswa['foto_profile']
                                    : 'https://ui-avatars.com/api/?name=' . urlencode($mahasiswa['nama']) . '&size=150&background=random'; ?>"
                        alt="Foto Profil" width="150" class="profile-photo">
